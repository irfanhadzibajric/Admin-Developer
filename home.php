...
<body>
	...
	<form method="post" action="home.php" style="width:90%;" >
		...
		-->
		<button type="submit" name="submit" id="add_btn" class="add_btn">Dodaj</button><br>
	</form>
	</center>
	<section id="grid" style="visibility: hidden;">
    	<center>
		<h1>Registrovani developeri:</h1>
		<br>
		<table style="width: 93%">
		<thead>
			<tr>
				<th>Registrovani developeri</th>
				<th>Email</th>
				<th>Brisanje</th>
